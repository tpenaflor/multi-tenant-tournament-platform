...
export const ImageBanner: React.FC<ImageBannerProps> = ({
  ...
  return (
    <div style={buildDesignCssVars(design)} className="group relative min-h-[480px] w-full overflow-hidden rounded-[2rem] bg-tenant-bg my-4">
      <img 
        src={imageUrl} 
        alt={title} 
      ...
      <div className="absolute inset-x-0 bottom-0 p-8 sm:p-12 text-white">
        ...
        {titleImage ? (
          <img src={titleImage} alt={title} className="mt-4 max-h-20 object-contain drop-shadow-lg" />
        ) : (
